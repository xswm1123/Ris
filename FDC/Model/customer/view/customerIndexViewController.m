...
//    self.photoIV.image=[UIImage imageWithContentsOfFile:[NSString stringWithFormat:@"%@%@",URL_LOGO ,user.logo]];
    NSLog(@"logoUrl=%@",[NSString stringWithFormat:@"%@%@",URL_LOGO ,user.logo]);
...
-(void)loadMonthPlanDatas{
    ...
    [manager queryMonthPlansForSellersWithObjectId:user.objectId UserId:user.userId success:^(id data, NSDictionary *userInfo) {
        ...
        [self.finishedCount_houses configLabelWithLeftName:@"实际销售金额" leftValue:nil rightName:nil rightValue:[sureDone objectForKey:@"ZD_ZDVAL"] labelFont: [UIFont systemFontOfSize:12] LlabelTextColor:[UIColor blackColor] RlabelTextColor:[UIColor blackColor]];
        
         [self.finishedCount_money configLabelWithLeftName:@"计划销售金额" leftValue:nil rightName:nil rightValue:[planDone objectForKey:@"ZD_ZDVAL"] labelFont: [UIFont systemFontOfSize:12] LlabelTextColor:[UIColor blackColor] RlabelTextColor:[UIColor blackColor]];
...
-(void)initView{
    ...
    self.finishedCount_houses=[[MCProgressBarView alloc]initWithFrame:CGRectMake(10, 60, DEVICE_WIDTH-20, 20) backgroundImage:[[UIImage imageNamed:@"darkGray.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10) ] foregroundImage:[[UIImage imageNamed:@"darkYelllow.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)]];
    self.finishedCount_houses.progress=1.0;
    //leftLabel
    self.finishedCount_houses.left_nameLabel.frame=CGRectMake(10, 2, 100, 16);
    self.finishedCount_houses.right_valueLabel.frame=CGRectMake(self.finishedCount_houses.frame.size.width-120, 2, 120, 16);
    [self.finishedCount_houses configLabelWithLeftName:@"实际销售金额" leftValue:nil rightName:nil rightValue:@"0万" labelFont: [UIFont systemFontOfSize:12] LlabelTextColor:[UIColor blackColor] RlabelTextColor:[UIColor blackColor]];
    [self.sellPlanView addSubview:self.finishedCount_houses];
    //==========================
    self.finishedCount_money=[[MCProgressBarView alloc]initWithFrame:CGRectMake(10, 90, DEVICE_WIDTH-20, 20) backgroundImage:[[UIImage imageNamed:@"darkGray.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10) ] foregroundImage:[[UIImage imageNamed:@"darkBlue.png"]resizableImageWithCapInsets:UIEdgeInsetsMake(10, 10, 10, 10)]];
    self.finishedCount_money.progress=0.0;
    //leftLabel
    self.finishedCount_money.left_nameLabel.frame=CGRectMake(10, 2, 100, 16);
    //rightLabel
    self.finishedCount_money.right_valueLabel.frame=CGRectMake(self.finishedCount_money.frame.size.width-120, 2, 120, 16);
    [self.finishedCount_money configLabelWithLeftName:@"计划销售金额" leftValue:nil rightName:nil rightValue:@"0万" labelFont: [UIFont systemFontOfSize:12] LlabelTextColor:[UIColor blackColor] RlabelTextColor:[UIColor blackColor]];
...
//    NSDate* startDate=[NSDate getFirstDayOfWeek];
//    NSDate* endDate=[NSDate getLastDayOfWeek];
//    NSString* startTime=[frm stringFromDate:startDate];
//    NSString* endTime=[frm stringFromDate:endDate];
